...
make_bd_pins_external  [get_bd_pins ether_protocol_spliter_0/s_axis_data]
make_bd_pins_external  [get_bd_pins ether_protocol_spliter_0/s_axis_keep]
make_bd_pins_external  [get_bd_pins ether_protocol_spliter_0/s_axis_last]
make_bd_pins_external  [get_bd_pins ether_protocol_spliter_0/s_axis_valid]
make_bd_pins_external  [get_bd_pins ether_protocol_assembler_0/eth_out_data]
make_bd_pins_external  [get_bd_pins ether_protocol_assembler_0/eth_out_keep]
make_bd_pins_external  [get_bd_pins ether_protocol_assembler_0/eth_out_valid]
make_bd_pins_external  [get_bd_pins ether_protocol_assembler_0/eth_out_last]
make_bd_pins_external  [get_bd_pins ether_protocol_assembler_0/eth_out_ready]
...
connect_bd_net [get_bd_ports myMac] [get_bd_pins ether_protocol_spliter_0/myMacAddr]
...
connect_bd_net [get_bd_pins ether_protocol_spliter_0/arp_data] [get_bd_pins arp_server_100g_0/arp_in_data]
connect_bd_net [get_bd_pins ether_protocol_spliter_0/arp_valid] [get_bd_pins arp_server_100g_0/arp_in_valid]
connect_bd_net [get_bd_pins ether_protocol_spliter_0/ip_data] [get_bd_pins udp_ip_server_100g_0/ip_in_data]
connect_bd_net [get_bd_pins ether_protocol_spliter_0/ip_valid] [get_bd_pins udp_ip_server_100g_0/ip_in_valid]
connect_bd_net [get_bd_pins ether_protocol_spliter_0/payload_data] [get_bd_pins udp_ip_server_100g_0/payload_in_data]
connect_bd_net [get_bd_pins ether_protocol_spliter_0/payload_valid] [get_bd_pins udp_ip_server_100g_0/payload_in_valid]
connect_bd_net [get_bd_pins ether_protocol_spliter_0/payload_last] [get_bd_pins udp_ip_server_100g_0/payload_in_last]
connect_bd_net [get_bd_pins ether_protocol_spliter_0/payload_len_data] [get_bd_pins udp_ip_server_100g_0/payload_length_data]
connect_bd_net [get_bd_pins ether_protocol_spliter_0/payload_len_valid] [get_bd_pins udp_ip_server_100g_0/payload_length_valid]
...
connect_bd_net [get_bd_pins axis_data_fifo_0/m_axis_tvalid] [get_bd_pins ether_protocol_assembler_0/eth_arp_in_valid]
connect_bd_net [get_bd_pins axis_data_fifo_0/m_axis_tready] [get_bd_pins ether_protocol_assembler_0/arp_ready]
connect_bd_net [get_bd_pins axis_data_fifo_0/m_axis_tdata] [get_bd_pins ether_protocol_assembler_0/eth_arp_in_data]
connect_bd_net [get_bd_pins axis_data_fifo_0/m_axis_tkeep] [get_bd_pins ether_protocol_assembler_0/eth_arp_in_keep]
connect_bd_net [get_bd_pins axis_data_fifo_0/m_axis_tlast] [get_bd_pins ether_protocol_assembler_0/eth_arp_in_last]
connect_bd_net [get_bd_pins axis_data_fifo_1/m_axis_tvalid] [get_bd_pins ether_protocol_assembler_0/eth_ip_in_valid]
connect_bd_net [get_bd_pins axis_data_fifo_1/m_axis_tready] [get_bd_pins ether_protocol_assembler_0/ip_ready]
connect_bd_net [get_bd_pins axis_data_fifo_1/m_axis_tdata] [get_bd_pins ether_protocol_assembler_0/eth_ip_in_data]
connect_bd_net [get_bd_pins axis_data_fifo_1/m_axis_tkeep] [get_bd_pins ether_protocol_assembler_0/eth_ip_in_keep]
connect_bd_net [get_bd_pins axis_data_fifo_1/m_axis_tlast] [get_bd_pins ether_protocol_assembler_0/eth_ip_in_last]
validate_bd_design
